        ...
        <div class="container-fluid p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('front.vans.vans') }}">Vans</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('front.bikes.bikes') }}">Bikes</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('front.motorhomes.motorhomes') }}">Motorhomes</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('front.caravans.caravans') }}">Caravans</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('front.trucks.trucks') }}">Trucks</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
