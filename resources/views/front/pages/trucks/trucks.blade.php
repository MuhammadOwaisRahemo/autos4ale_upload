...
@section('content')
            ...
            <div class="advertise">
                <div class="row g-0">
                    <div class="col-md-7 bg-theme">
                        <div class="madvertise_text text-white ps-5">
                            <h3 class="pt-5 ps-5">Place an advert on <br> Auto4sale</h3>
                            <p class=" ps-5">Get the price you deserve</p>
                            <form class="row ps-5">
                                <!-- <div class="col-md-6">
    ...
    <div class="container-fluid py-4 grey_bg">
        <div class="container">
            <div class="row">
                <div class="text-center top_content">
                    <p>Local featured dealer</p>
                    <h2 class="fw-bold">Geoff Sipson Commercials Ltd</h2>
                </div>
            </div>

            <div class="row cars_reviews mt-4">
                <div class="col-md-4 bg-white box-shadow">
                    <a href="#">
                        <img src="{{ asset('front_assets') }}/images/truckimg.png" class="img-fluid mx-auto d-block mt-4">
                    </a>
                    <h4 class="mt-3">
                        <a href="#">
                            POA
                    ...
                    <h5 class="fw-500 fs-14">Mercedes-Benz</h5>
                    <p class="mb-0">Mercedes-Benz Arocs 1824 18 TON EXTEN….</p>

                    <a href="#" class="btn btn-theme w-100 mt-3 det_btn">Show Details</a>
                </div>

                @foreach ($new_trucks as $value)
                <div class="col-md-4 bg-white box-shadow">
                    <a href="{{ route('front.cars.single_car_details', $value->hashid) }}">
                        <img src="{{ check_file($value->car_images[0]->image) }}"
                        class="img-fluid mx-auto d-block" style="width: 277px;
                                    height: 208px;">
                    </a>
                    <h4 class="mt-3">
                        <a href="{{ route('front.cars.single_car_details', $value->hashid) }}">
                    ...
                    <h5 class="fw-500 fs-14">{{ $value->car_details->ad_title }}</h5>
                    <p class="mb-0">{{ $value->car_details->subtitle }}</p>
                ...
                <div class="text-md-end mt-4">
                    <a href="#" class="btn btn-theme stock_btn">Show All Stock</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid guides_section sell_guid mt-5 mb-5">
        <div class="container">
            <div class="row">
                <div class="text-center top_content">
                    <h2 class="fw-bold">Truck services and products</h2>
                </div>
                <div class="col-12 mt-4">
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <div class="guid pt-3">
                                <h4 class="mt-2">Commerical truck exports</h4>
                                <p class="fs-16">Here at Auto4Sale Trucks you’ll be able to find a fantastic
                                    choice of reputable and experienced businesses dealing specifically in commercial truck
                                    exports. If you’re searching for a reliable and cost effective shipping option for
                                    moving trucks and plant around the <a href="#"
                                        class="text-theme text-decoration-none">Readmore</a></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="guid">
                                <h4 class="mt-2">Truck parts & accessories</h4>
                                <p class="fs-16">For new or reconditioned truck parts and accessories visit one of
                                    our partners today. <a href="#" class="text-theme text-decoration-none">Readmore</a></p>
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="guid">
                                <h4 class="mt-2">Truck Rental, Hire & Lease</h4>
                                <p class="fs-16">For commercial vehicle hire, rental or lease, visit our partners
                                    today. With single and fleet packages available you’ll find something to suit your
                                    business. <a href="#" class="text-theme text-decoration-none">Readmore</a></p>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-3">
                            <div class="text-center brands">
                                <img src="{{ asset('front_assets') }}/images/scania.png"
                                    class="pt-3 img-fluid mx-auto d-block">
                                <h4 class="mt-2">Scania</h4>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center brands">
                                <img src="{{ asset('front_assets') }}/images/volvo.png"
                                    class="pt-3 img-fluid mx-auto d-block">
                        ...
                        <div class="col-md-3">
                            <div class="text-center brands">
                                <img src="{{ asset('front_assets') }}/images/daf.png"
                                    class="pt-3 img-fluid mx-auto d-block">
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p class="text_color">When you sell your car, you’ll need to hand over the
                                            car’s handbook, the service logbook (plus receipts) and, if the car is over
                                            three years old, the MOT certificate. Buyers may also appreciate older MOT
