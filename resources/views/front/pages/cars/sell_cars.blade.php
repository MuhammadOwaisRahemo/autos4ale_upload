...
<div class="container-fluid main-bannerbg">
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center">
				<ul class="list-inline">
					<li class="list-inline-item">
						<a href="{{ route('front.home') }}">Cars for sale</a>
					</li>

					<li class="list-inline-item">
						<a href="{{ route('front.cars.used_cars') }}">Used Cars</a>
					</li>

					<li class="list-inline-item">
						<a href="{{ route('front.cars.new_cars') }}">New Cars</a>
					</li>

					<li class="list-inline-item">
						<a href="{{ route('front.cars.sell_my_car') }}">Sell My Car</a>
					</li>

					<li class="list-inline-item">
						<a href="{{ route('front.cars.electric_cars') }}">Electric Cars</a>
					</li>

					<li class="list-inline-item">
						<a href="{{ route('front.cars.leasing_cars') }}">Car Leasing</a>
					</li>

					<li class="list-inline-item">
						<a href="{{ route('front.cars.car_blogs') }}">Car Blogs</a>
					</li>

					<li class="list-inline-item">
						<a href="{{ route('front.cars.buy_new_car') }}">Buy A Car</a>
					</li>

					<li class="list-inline-item">
						<a href="{{ route('front.cars.car_value') }}">Value Car</a>
					</li>

				</ul>

				<div class="text-white">
					<h1 class="fw-bold">You’re in control, choose how you want to sell your car</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="row">
					<div class="col-md-6">
						<div class="thum_content bg_lightwhite sell_offeer">
							<h4>Get an instant offer</h4>
							<p>Tell us more about your car to get an instant offer, valid for 7 days</p>
							<img src="{{ asset('front_assets') }}/images/img-1.png" class="img-fluid mx-auto d-block mt-4">
						</div>
					</div>
					<div class="col-md-6">
						<div class="thum_content bg_lightwhite sell_offeer">
							<h4>Place an advert on Auto4sale</h4>
							<p>3 simple steps to your advert online</p>
							<img src="{{ asset('front_assets') }}/images/img-2.png" class="img-fluid mx-auto d-block mt-4">
						</div>
					</div>

					<div class="text-center mt-4">
						<a href="#" class="btn btn-theme advert_pricebtn mb-3">See Advertising Pricing</a>
					</div>
	...
	<div class="container">
		<div class="advertise">
			<div class="row g-0">
				...
				<div class="col-md-5">
					<div class="madvertise_text newadvertise_text">
						...
						<h2 class="fw-bold mt-5">Free online valuation</h2>
						<p class="text_color">Our powerful valuation tool helps you to price your car competitively so you can make sure you’re getting a fair price. We’ll guide you through creating your advert and give helpful tips to make it stand out.</p>
					</div>
				</div>
			</div>
		</div>
