					...
					{{-- <div class="col-md-4">
						<div class="blog_item">
							<a href="blog-single.html">
								<img src="{{ asset('front_assets') }}/images/van-blog.png" class="img-fluid">
								<h4 class="mt-4">What kind of licence do you need to drive a van?</h4>
							</a>
							<p class="text_color">
	...
	<div class="container">
		<div class="advertise">
			<div class="row g-0">
				<div class="col-md-5">
					<div class="right_img">
						<img src="{{ asset('front_assets') }}/images/left-van.png" class="img-fluid" />
					</div>
				</div>
				<div class="col-md-7">
					<div class="madvertise_text van_blogadvert">
						<h2 class="fw-bold">Mercedes-Benz eSprinter Panel Van (2021 - ) review</h2>
