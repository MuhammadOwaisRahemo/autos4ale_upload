...
<div class="container-fluid py-4">
	<div class="container">
		...
		<div class="row cars_reviews mt-4">
			<div class="col-md-4">
				<a href="#">
					<img src="{{ asset('front_assets') }}/images/motohome_review.png" class="img-fluid mx-auto d-block">
				</a>
				<h4 class="mt-3">
					<a href="#">
				...
				<p class="mb-0">Finance can be confusing, you need to know your balloon payments from your monthly instalments, and your PCPs from your HP. Let us help you understand them.</p>
