            ...
            <div class="col-12">
                ...
                <div class="row align-items-center">
                    <div class="col-md-10">
                        ...
                        <span name="name"> &nbsp; &nbsp; <strong>{{ auth('user')->user()->email ?? '' }}</strong>
                        </span><br><br>
                ...
                @if (auth('user')->user()->trade_seller == 0)
                    ...
                    <hr>
                @endif
                <div class="trade_seller {{ auth('user')->user()->trade_seller == 0 ? 'd-none' : '' }}">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5 mt-3">
                                <input type="text" class="form-control  @error('post_code') is-invalid @enderror"
                                    placeholder="Your Post Code" value="{{ auth('user')->user()->postal_code ?? '' }}"
                                    name="post_code">
                                @error('post_code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
