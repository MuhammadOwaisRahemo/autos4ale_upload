            ...
            <div class="col-12">
                ...
                <div class="row align-items-center">
                    <div class="col-md-10">
                        ...
                        <span name="name"> &nbsp; &nbsp; <strong>{{ auth('user')->user()->email ?? '' }}</strong> </span><br><br>
                        <label for="dname">Password : </label>
                        <span name="dname"> &nbsp; &nbsp; <strong>*********</strong> </span>
                    </div>
                    <div class="col-md-2">
                ...
                <form action="{{ route('front.save_personal_details') }}" method="post">
                    @csrf
                    <div class="row align-items-center">
                        <div class="col-md-5">
                            <input type="text" class="form-control @error('first_name') is-invalid @enderror" placeholder="First Name" value="{{ auth('user')->user()->first_name ?? '' }}" name="first_name">
                            @error('first_name')
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control @error('sur_name') is-invalid @enderror" placeholder="Surname" value="{{ auth('user')->user()->sur_name ?? '' }}" name="sur_name">
                            @error('sur_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control @error('display_name') is-invalid @enderror" placeholder="Display Name" value="{{ auth('user')->user()->display_name ?? '' }}" name="display_name">
                            @error('display_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('front.personal_details') }}" class="btn btn-outline btn-primary">
                                Cancel
                            </a>
                        </div>
                    </div>
