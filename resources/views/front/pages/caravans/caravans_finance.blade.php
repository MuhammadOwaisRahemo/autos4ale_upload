...
<div class="container-fluid py-4">
	<div class="container">
		...
		<div class="row cars_reviews mt-4">
			<div class="col-md-4">
				<a href="#">
					<img src="{{ asset('front_assets') }}/images/blog-canvan.png" class="img-fluid mx-auto d-block">
				</a>
				<h4 class="mt-3">
					<a href="#">
				...
				<p class="mb-0" style="min-height: 70px;">f you want to buy a caravan but can’t afford to purchase it upfront, taking out a loan is something you’re probably considering. But with all the different options of caravan finance that are available, it can be confusing.</p>
			...
			<div class="col-md-4">
				...
				<p class="mb-0" style="min-height: 70px;">Finance can be confusing, you need to know your balloon payments from your monthly instalments, and your PCPs from your HP. Let us help you understand them.</p>
				<div class="btm-text text-end mt-2">
					<p>Expert review | 10 days ago</p>
				</div>
			</div>
