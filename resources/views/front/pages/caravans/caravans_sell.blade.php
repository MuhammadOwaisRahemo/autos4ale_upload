				...
				<div class="row">
						...
						<div class="row align-items-center">
							<div class="col-md-12">
								<div class="thum_content">
									<h4>Sell your caravan from £14.95</h4>
					...
					<div class="col-md-4">
						<div class="row align-items-center">
							<div class="col-md-12">
								<div class="thum_content">
									<h4>Advertise to over 340,000 buyers</h4>
			...
			<div class="row g-0">
				...
				<div class="col-md-6">
					<div class="madvertise_text advert_mill mt-3" style="background-color: #FAFAFA;">
						...
						<p class="text_color">With thousands of caravan buyers on our website daily, it’s highly likely someone is currently searching our website for the caravan that’s sat on your driveway, or in storage. If you have a popular model, it can sell within 24 hours.</p>
	...
	<div class="container">
		<div class="advertise">
			<div class="row g-0">
				...
				<div class="col-md-6">
					<div class="madvertise_text canavans_advert mt-3" style="background-color: #FAFAFA;">
						<h2 class="fw-bold">Get the most money</h2>
						<p class="text_color">Unlike other websites, we won’t take a cut of the price – it’s your caravan, it’s your money. <br>
						Our advertising packages start from just £14.95 - a small price compared to the amount you could lose to a caravan buying site.</p>
